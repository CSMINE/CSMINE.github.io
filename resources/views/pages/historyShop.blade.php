...
<head>
    ...
    <title>CSGO-GOOSE SHOP - Магазин Counter Strike: Global Offensive</title>
...
"></a>
            <nav class="header-nav">
                    ...
                    <li><a href="http://steamcommunity.com/profiles/76561198247652662/inventory/" target="_blank">Инвентарь бота</a></li>
                    <li><a href="http://vk.com/csgopalace_ru" target="_blank">Поддержка</a></li>
                </div>
...
">
                        ...
                        <li class="balance-wrap">
                            ...
                            <div id="balanceInput" class="add-balance-input" style="display:none;">
                                <div class="form-control">
                                    <form action="http://csgopalace.ru/pay" method="get">
                                        <input type="hidden" name="account" value="{{ $u->id }}">
                                        <input type="text" id="sum" name="sum" placeholder="Введите сумму">
        ...
        <div class="body-content">
            ...
            <div class="memoMsg">
                ...
                А также, если вдруг у вас стоит статус "Отправлено", но предложение обмена вам не пришло (или вы его случайно отклонили) деньги тоже будут автоматически возвращены на баланс в течении часа.<br><hr>
				<center><font color="red"><b>ВНИМАНИЕ!</b></font> <font color="white">После покупки получения обмена, вам нужно принять его в течении 10 минут! <b>Иначе обмен будет отменен!</b></font></center>
            </div>
...
<div style="display:none;">
    <div id="contactsModal">
        <div class="supModalbsc">
            ...
            <a class="vksupBtn" href="http://support.csgo-cash.com/" target="_blank">Отправить сообщение саппорту</a>
        </div>
    </div>
</div>
    ...
    <div id="botsModal">
        <div class="supModalbsc">
            ...
            <div class="botList clearfix">
                <img src="http://cdn.akamai.steamstatic.com/steamcommunity/public/images/avatars/fe/fef49e7fa7e1997310d705b2a6158ff8dc1cdfeb_medium.jpg"></img>
                <div style="float: left; margin-top: 2px;">
                    <span>CSGO-CASH.COM [BOT] #1</span><br>
                    <a href="http://steamcommunity.com/id/csgocash/inventory/" target="_blank">Посмотреть инвентарь</a>
                </div>
            </div>
        </div>
    </div>

...
<div class="row">
	<div class="col-xs-12">
		<div class="page-title-box">
			<h4 class="page-title">Редактор ботов</h4>
...
<div class="card-box">
    <div class="well panel-body">
        <form method="post" action="/admin/bot_edit/{{$bots->id}}" class="form-horizontal" id="bot_edit">
			...
			<div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="steamid64" value="{{$bots->steamid64}}" placeholder="..."
                           class="form-control">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="username" value="{{$bots->username}}" placeholder="..."
                           class="form-control">
                </div>
            </div>
			</fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="password" value="{{$bots->password}}" placeholder="..."
                           class="form-control">
                </div>
            </div>
			</fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="identity" value="{{$bots->identity}}" placeholder="..."
                           class="form-control">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="trade_link" value="{{$bots->trade_link}}" placeholder="..."
                           class="form-control">

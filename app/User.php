...
class User extends Model implements AuthenticatableContract, CanResetPasswordContract
{
	...
	public function placeInGame($game)
    {
        return $this->bets()->where('game_id', $game->id)->max('place');
    }
	...
	public function itemsPriceByGame($game)
    {
        return $this->bets()->where('game_id', $game->id)->sum('price');
    }
}
